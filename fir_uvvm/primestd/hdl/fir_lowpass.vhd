...
--!			sampling frequency 2khz, passes 0 to 400Hz, filters out 500hz to 1000Hz (nyquist limit).
--!			Coefficients are generated by http://t-filter.engineerjs.com/, passed in as generic. 
--!			It requires and expects reset at the beginning of every packet, also the
--!			input signal must return to zero for FIR to work.
